...
/**
 * Contains static key inline varants to be used by Input.
 */
class Key 
{
	...
	public static inline var LEFT_SQUARE_BRACKET:Int = 219;
	public static inline var RIGHT_SQUARE_BRACKET:Int = 221;
