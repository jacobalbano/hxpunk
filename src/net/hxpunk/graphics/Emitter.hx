package net.flashpunk.graphics 
{
	...
	public class Emitter extends Graphic
	{
		 ...
		 */
		public function Emitter(source:Dynamic, frameWidth:Int = 0, frameHeight:Int = 0) 
		{
		...
		{
			if (source is Class) _source = HP.getBitmap(source);
		 ...
		 */
		private function get_particleCount():Int { return _particleCount; }
